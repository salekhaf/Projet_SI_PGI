<?php
/**
 * Script pour restaurer le contenu du dashboard
 * À partir d'une sauvegarde ou recréation
 */

// Le vrai contenu du dashboard devrait être ici
// Pour l'instant, créons une version de base qui fonctionne
...
// Écrire le fichier
file_put_contents(__DIR__ . '/pages/dashboard/index.php', $dashboard_content);

echo "<h2>✅ Dashboard restauré</h2>";
echo "<p>Le fichier <code>pages/dashboard/index.php</code> a été restauré avec succès.</p>";
