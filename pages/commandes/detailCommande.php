...
/*************************************************
 * 1 — Récupération des infos principales
 *************************************************/
$stmt = $pdo->prepare("
...
/*************************************************
 * 2 — Récupération des produits achetés
 *************************************************/
$stmt = $pdo->prepare("
...
<div class="main-container">
    <div class="content-wrapper">
        ...
        <div class="card" style="margin-bottom: 25px;">
            <h3>Fournisseur</h3>
            <p>
                <strong>Nom :</strong> <?= htmlspecialchars($achat['fournisseur']) ?><br>
                <strong>Email :</strong> <?= htmlspecialchars($achat['email'] ?? '—') ?><br>
                <strong>Téléphone :</strong> <?= htmlspecialchars($achat['telephone'] ?? '—') ?>
            </p>
        </div>
        ...
        <div class="card" style="margin-bottom: 25px;">
            ...
            <p>
                <strong>Date :</strong> <?= date('d/m/Y H:i', strtotime($achat['date_achat'])) ?><br>
                <strong>Total :</strong>
